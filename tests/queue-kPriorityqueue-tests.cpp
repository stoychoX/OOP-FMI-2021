...
//of psn::Queue and psn::kPriorityQueue
//
#include<iostream>
#include"Queue.hpp"
...
int main() {
	...
	std::cout << "\nFirst popping elements with priority 2, which are equivalent to numbers with mod 2, then with priority 1, and last popping the elements divisible by 3." << end;
}
